...
[Smluvní strany	3](#smluvní-strany)

[I. Předmět smlouvy	3](#i.-předmět-smlouvy)

[II. Doba plnění	4](#ii.-doba-plnění)

[III. Práva a povinnosti smluvních stran	4](#iii.-práva-a-povinnosti-smluvních-stran)

[IV. Převzetí a předání díla	5](#iv.-převzetí-a-předání-díla)

[V. Vlastnické právo a nebezpečí škody na díle	5](#v.-vlastnické-právo-a-nebezpečí-škody-na-díle)

[VI. Cena za dílo a platební podmínky	5](#vi.-cena-za-dílo-a-platební-podmínky)

[VII. Odpovědnost za vady díla	6](#vii.-odpovědnost-za-vady-díla)

[VIII. Odstoupení od smlouvy	6](#viii.-odstoupení-od-smlouvy)

[IX. Ochrana informací	7](#ix.-ochrana-informací)

[X. Smluvní pokuty a náhrada škody	7](#x.-smluvní-pokuty-a-náhrada-škody)

[XII. Závěrečná ustanovení	9](#xii.-závěrečná-ustanovení)

[Příloha A – Popis díla	10](#příloha-a-–-popis-díla)

[Příloha B – kalkulace ceny díla	12](#příloha-b-–-kalkulace-ceny-díla)

[Příloha C – časový harmonogram zhotovení díla	13](#příloha-c-–-časový-harmonogram-zhotovení-díla)

# **Smlouva o dílo č. 2025-001**
...
**Objednatel:** SANSEI spol. s r.o.

* Sídlo: Rybářská 839/2, Stará Role, 360 17 Karlovy Vary  
* IČO: 29122040  
* DIČ (DPH): CZ29122040  
* Jednatel: Olga Maksimova
...
1. Zhotovitel se zavazuje celé dílo popsané v této smlouvě a v příloze A provést nejpozději do 30.03.2024. Podrobný harmonogram je uveden v příloze C, která je nedílnou součástí této smlouvy.  
...
4. Osobou oprávněnou k převzetí díla za objednatele je Taisija Jasinská  
5. Osobou oprávněnou k předání díla za zhotovitele je Elchin Huseynli.  
6. Místem převzetí díla jsou Karlovy Vary, Česká republika.
...
1. Objednatel se zavazuje za dílo zaplatit celkovou smluvní cenu ve výši 75 000,- Kč (slovy: sedmdesát pět tisíc korun českých). Zhotovitel není plátcem DPH.  
...
4. Objednatel je povinen zaplatit zálohu ve výši 50 % z ceny díla, které je předmětem podle této smlouvy. Tuto zálohu uhradí na účet zhotovitele číslo 2096701002/5500 do tří dnů od podpisu této smlouvy.  
...
3. Zhotovitel dává záruku za jakost díla. Záruční doba je stanovena na 6 měsíců.  
...
1. Jestliže zhotovitel bude v prodlení s provedením jím zhotovovaného díla, je objednatel oprávněn požadovat po zhotoviteli smluvní pokutu ve výši 0,05 % z celkové ceny díla za každý den prodlení.cl  
...
| :---- | :---- |
| **Objednatel:** |  |
| V Karlových Varech, dne | 2025-01-21 |
| **Zhotovitel:** |  |

## **Příloha A – Popis díla** {#příloha-a-–-popis-díla}

Dílem se rozumí soubor grafických a webových prací pro klienta, zahrnující následující položky:

1. Návrh a implementace kompletních webových stránek. Tato část díla zahrnuje:  
   ...
   * Integrace vícejazyčnosti (plugin Weglot \- placený zadavatelem)  
   * Integrace online rezervačního systému (externí plugin \- placený zadavatelem)  
   * Optimalizace pro podporované webové prohlížeče: Chrome, Firefox, Safari, Opera (aktuální verze a dvě předchozí verze)  
   * Základní SEO optimalizace včetně nastavení meta tagů, optimalizace URL struktury a vytvoření sitemap  
   ...
   * Tvorbu textového obsahu (copywriting) pro webové stránky  
   * Implementace správy cookies v souladu s GDPR (včetně banneru pro souhlas s cookies)  
   * Propojení se sociálními sítěmi včetně integrace sdílecích tlačítek  
   * Optimalizace rychlosti načítání stránek  
   * Implementace kontaktního formuláře s ochranou proti spamu  
   * Základní školení pro správu obsahu v redakčním systému WordPress (2 hodiny)
...
| Název položky | Cena |
| :---- | ----- |
| Tvorba webových stránek | 75 000,00 Kč |
| **Cena celkem:** | 75 000,00 Kč |
...
| :---- | ----- | ----- |
| Tvorba prototypů webu | 1.2.2025 | 15.2.2025 |
| Tvorba webových stránek | 15.2.2025 | 10.3.2025 |
| Integrace online rezervačního systému | 10.3.2025 | 17.3.2025 |
| Interní testování a testování klientem | 17.3.2025 | 22.3.2025 |
| Předání do provozu a zaškolení klienta | 22.3.2025 | 30.3.2025 |
